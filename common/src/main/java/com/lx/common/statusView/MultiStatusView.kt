package com.lx.common.statusView
...
class MultiStatusView @JvmOverloads constructor(
    ...
    init {
        ...
        mEmptyViewResId = typeArry.getResourceId(R.styleable.MultiStatusView_emptyView, R.layout.status_empty_view)
        mErrorViewResId = typeArry.getResourceId(R.styleable.MultiStatusView_errorView, R.layout.status_error_view)
        mLoadingViewResId = typeArry.getResourceId(R.styleable.MultiStatusView_loadingView, R.layout.status_loading_view)
        mNoNetworkViewResId = typeArry.getResourceId(R.styleable.MultiStatusView_noNetworkView, R.layout.status_no_network_view)
